    ...
    for (int chunk = 0; chunk < nrhs; chunk += 4)
    {
        ...
        for (int block = Symbolic->nblocks - 1; block >= 0; block--)
        {
            ...
            else
            {
                ...
                KLU_lsolve(nk, Numeric->Lip + k1, Numeric->Llen + k1, &Numeric->LUbx[lusize_sum], nr, Numeric->Xwork + nr * k1);
                KLU_usolve(nk, Numeric->Uip + k1, Numeric->Ulen + k1, &Numeric->LUbx[lusize_sum], Numeric->Udiag + k1, nr, Numeric->Xwork + nr * k1);
            }
...
int main(void)
{
    ...
    Numeric.Lip = (int *)malloc(n * sizeof(int));
    ...
    Numeric.LUbx = (double *)malloc(lusize * 2 * sizeof(double));
    ...
    Numeric.Xwork = (double *)malloc(Numeric.worksize);
