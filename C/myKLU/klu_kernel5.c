    ...
    KLU_common *Common)
{
    Entry x[4], offik, s;
    double rs;
    int k1, k2, nk, k, pend, p, nr, i, n = d;
...
int main(void)
{
    ...
    klu_solve2(Symbolic.Q, Symbolic.R, Numeric.Pnum, Numeric.Offp, Numeric.Offi, Numeric.Lip, Numeric.Uip, Numeric.Llen, Numeric.Ulen, Numeric.Offx, Numeric.Xwork, Numeric.Udiag, Numeric.Rs, Numeric.LUbx, Numeric.LUsize, Symbolic.nblocks, n, 1, b, &Common);
